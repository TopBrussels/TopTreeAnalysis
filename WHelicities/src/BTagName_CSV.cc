#include "../interface/BTagName_CSV.h"

BTagName_CSV::BTagName_CSV(){    
...
std::string BTagName_CSV::NameGiving(int TCHEbTagLoop, int NumberTCHEbTags,  int TCHPbTagLoop, int NumberTCHPbTags, int SSVHEbTagLoop, int NumberSSVHEbTags, int SSVHPbTagLoop, int NumberSSVHPbTags,int CSVbTagLoop, int NumberCSVbTags){
...
std::string BTagName_CSV::NameGivingPres(int TCHEbTagLoop, int NumberTCHEbTags,  int TCHPbTagLoop, int NumberTCHPbTags, int SSVHEbTagLoop, int NumberSSVHEbTags, int SSVHPbTagLoop, int NumberSSVHPbTags,int CSVbTagLoop, int NumberCSVbTags){
