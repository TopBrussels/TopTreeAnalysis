#include "../interface/BTagJetSelection_CSV.h"

using namespace std;

BTagJetSelection_CSV::BTagJetSelection_CSV(){
...
int BTagJetSelection_CSV::HighestProbSelection(int bTagLoop, int ConsideredBTagger, vector<float> KinFitProb, vector<float> MlbProb, vector<float> btagTCHE, vector<float> btagTCHP, vector<float> btagSSVHE, vector<float> btagSSVHP, vector<float> btagCSV){
