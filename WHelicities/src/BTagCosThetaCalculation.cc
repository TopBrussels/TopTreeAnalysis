...
float BTagCosThetaCalculation::Calculation(TLorentzVector muon, TLorentzVector Neutrino, TLorentzVector leptonicBJet){
...
// 	Neutrino.SetPxPyPzE(NeutrinoPx,NeutrinoPy,NeutrinoPz,NeutrinoE);	  
	...
	TLorentzVector TopLeptonic = (Neutrino+muon+leptonicBJet);
