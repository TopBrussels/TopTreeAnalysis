...
MinuitFitterPerforming::MinuitFitterPerforming(string Name, int CosThetaBinNumber, int ndimen, int iDataSet, vector<float> CosThetaValuesKinFit[], vector<float> CosThGenKinFit[], vector<float> EventCorrectionWeightKinFit[], string dataSetName, bool semiMuon, bool semiElectron, bool SignalOnly, bool DataResults, bool JESResults, bool JERResults, bool WSystResults, bool TTScalingResults, bool TTMatchingResults, bool PUResults, bool UnclusEnergyResults, bool TopMassResults, bool TriggEvtSelResults, bool bTagResults, int dataSetsSize){
  ...
  if(iDataSet==0){
    FMinusTex<<" bTagger & FL result & Stat uncert & JES Syst & JER Syst & W Syst & TTScale Syst & TTMatch Syst & TTMatch Up & PU Syst & UnclusEnergy Syst & Top Mass Syst & TriggEvtSel Syst & BTagSyst & Total Syst uncert & Total uncert "<<endl;
    FPlusTex<<" bTagger & FR result & Stat uncert & JES Syst & JER Syst & W Syst & TTScale Syst & TTMatch Syst & TTMatch Up & PU Syst & UnclusEnergy Syst & Top Mass Syst & TriggEvtSel Syst & BTagSyst & Total Syst uncert & Total uncert "<<endl;
    FZeroTex<<" bTagger & F0 result & Stat uncert & JES Syst & JER Syst & W Syst & TTScale Syst & TTMatch Syst & TTMatch Up & PU Syst & UnclusEnergy Syst & Top Mass Syst & TriggEvtSel Syst & BTagSyst & Total Syst uncert & Total uncert "<<endl;
    NormTex<<" bTagger  & Normalisation & Stat uncert & JES Syst & JER Syst & W Syst & TTScale Syst & TTMatch Syst & TTMatch Up & PU Syst & UnclusEnergy Syst & Top Mass Syst & TriggEvtSel Syst & BTagSyst & Total Syst uncert & Total uncert "<< endl;
    NormBckgTex<<" bTagger  & Normalisation (Bckg) & Stat uncert & JES Syst & JER Syst & W Syst & TTScale Syst & TTMatch Syst & TTMatch Up & PU Syst & UnclusEnergy Syst & Top Mass Syst & TriggEvtSel Syst & BTagSyst & Total Syst uncert & Total uncert "<< endl;
  }  
