...
SOURCESTOPFCNC   = $(wildcard Content/src/AnalysisEnvironment.cc Content/src/Dataset.cc KinFitter/src/*.cc MCInformation/src/JetPartonMatching.cc MCInformation/src/*ReWeighting.cc MCInformation/src/ResolutionFit.cc Reconstruction/src/*JetCorr*.cc Reconstruction/src/MEzCalculator.cc Reconstruction/src/Observables.cc Selection/src/Selection*.cc Tools/src/AnalysisEnvironmentLoader.cc Tools/src/JetTools.cc Tools/src/MultiSamplePlot.cc Tools/src/PlottingTools.cc Tools/src/TTreeLoader.cc TopFCNC/src/TopFCNC_KinFit.cc tinyxml/*.cc)
HEADERSTOPFCNC   = $(wildcard Content/interface/AnalysisEnvironment.h Content/interface/Dataset.h KinFitter/interface/*.h MCInformation/interface/JetPartonMatching.h MCInformation/interface/*ReWeighting.h MCInformation/interface/ResolutionFit.h  Reconstruction/interface/*JetCorr*.h Reconstruction/interface/MEzCalculator.h Reconstruction/interface/Observables.h Selection/interface/Selection*.h Tools/interface/AnalysisEnvironmentLoader.h Tools/interface/JetTools.h Tools/interface/MultiSamplePlot.h Tools/interface/PlottingTools.h Tools/interface/TTreeLoader.h TopFCNC/interface/TopFCNC_KinFit.h tinyxml/*.h)
...
topfcnc: libTopFcncAnalysis42.$(DllSuf)
	cp libTopFcncAnalysis42.$(DllSuf) ~/lib/
