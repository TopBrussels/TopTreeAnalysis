//////////////////////////////////////////////////////////
// This class has been cloned from freyaisis_looper.h
//////////////////////////////////////////////////////////

#ifndef isis_looper_h
#define isis_looper_h
...
isis_looper::isis_looper(TTree *tree) : fChain(0) 
{
  Init(tree);
}

isis_looper::~isis_looper()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t isis_looper::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t isis_looper::LoadTree(Long64_t entry)
{
...
void isis_looper::Init(TTree *tree)
{
...
void isis_looper::Show(Long64_t entry)
{
