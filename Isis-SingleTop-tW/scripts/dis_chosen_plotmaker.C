...
void dis_chosen_plotmaker(int mode = 0){
  ...
  TString cutLabel[nPlots] =     {   "njets", "ptsys",  "pt_leading"};
  int rebinHisto[nPlots] =       {  1, 4, 4};
  TString cutTitle[nPlots] =     { "# of jets",  "P_{T} system [GeV]", "P_{T} of the leading jet"};
