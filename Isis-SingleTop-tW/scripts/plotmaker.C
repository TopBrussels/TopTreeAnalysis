...
void plotmaker(int mode = 0){
  ...
  TString cutLabel[nPlots] =     { "cuts", "met", "mll", "njets", "njetsbt", "ptsys", "ht", "pt_leading", "nvertex_2lep", "nvertex", "pt_max", "pt_min","njets_noHT","njetsbt_noHT","njetsbt_noHT_loose","njets_begin","njetsbt_begin","njetsbt_begin_loose"};
  int rebinHisto[nPlots] =       { 1, 4, 4, 1, 1, 4, 12, 4, 1, 1,2, 2,1,1,1,1,1,1};
