...
*/
  ...
  cout << "*************************************************************" << endl;
  cout << " Beginning of the program for the FCNC background estimation ! " << endl;
  cout << "*************************************************************" << endl;
  ...
  //Global variable
  TRootEvent* event = 0;
  TopFCNC_Evt* MyTopFCNC_BckgdEvtCand = 0;
  ...
  MSPlot["BdiscBJetCand_me_ch_CVS"]           = new MultiSamplePlot(datasets, "BdiscBJetCand_me_ch_CVS", 50, 0, 1, "CSV b-disc.");
  ...
  MSPlot["BdiscBJetCand_me_ch_TCHE"]          = new MultiSamplePlot(datasets, "BdiscBJetCand_me_ch_TCHE", 50, 0, 50, "TCHE b-disc.");
  ...
  MSPlot["HighestBdisc_me_ch_TCHE"]           = new MultiSamplePlot(datasets, "HighestBdisc_me_ch_TCHE",50, 0, 50, "TCHE b-disc.");
  ...
  MSPlot["Mtt_me_ch"]                         = new MultiSamplePlot(datasets, "Mtt_me_ch",  50, 0, 1000, "m_{t#bar{t}} [GeV/c^{2}]");
  ...
  MSPlot["Mzq_me_ch"]                         = new MultiSamplePlot(datasets, "Mzq_me_ch",  50, 80, 300, "m_{Zq} [GeV/c^{2}]");
  ...
  MSPlot["MassChi2_me_ch"]                    = new MultiSamplePlot(datasets, "MassChi2_me_ch",  20, 0, 20, "\\chi^{2}");
  ...
  MSPlot["MassChi2_SM_me_ch"]                 = new MultiSamplePlot(datasets, "MassChi2_SM_me_ch",  20, 0, 20, "\\chi^{2}");
  ...
  MSPlot["MassChi2_FCNC_me_ch"]               = new MultiSamplePlot(datasets, "MassChi2_FCNC_me_ch",  20, 0, 20, "\\chi^{2}");
  ...
  for (unsigned int d = 0; d < datasets.size(); d++){
	  histo2D[("MET_vs_Mzq_me_ch_"+datasets[d]->Name()).c_str()] = new TH2F(("MET_vs_Mzq_me_ch_"+datasets[d]->Name()).c_str(),"MET:m_{zq}", 50, 0, 200, 50, 80, 300);
	  ...
	  histo2D[("MET_vs_Mzq_ee_ch_"+datasets[d]->Name()).c_str()] = new TH2F(("MET_vs_Mzq_ee_ch_"+datasets[d]->Name()).c_str(),"MET:m_{zq}", 50, 0, 200, 50, 80, 300);
  }
...
//  pathPNG = pathPNG +"/"; 	
  ...
  sprintf(btagcutname,"$b\\texttt{-}disc \\leq %f$ (CSV)",btagcut);
