  ...
  for (unsigned int d = 0; d < datasets.size (); d++)
    {
      ...
      if  (isRAW) sprintf(rootFileName,"outputs/EleStudies_naked_%d_%s.root", mode, name);
      else if(!isData && JESPlus) sprintf(rootFileName,"outputs/EleStudies_JESsysUp_%d_%s.root", mode, name);
      else if (!isData && JESMinus) sprintf(rootFileName,"outputs/EleStudies_JESsysDown_%d_%s.root", mode, name);
      else if (!isData && JERMinus) sprintf(rootFileName,"outputs/EleStudies_JERsysDown_%d_%s.root", mode, name);
      else if (!isData && JERPlus) sprintf(rootFileName,"outputs/EleStudies_JERsysUp_%d_%s.root", mode, name);
      else if (!isData && SFplus) sprintf(rootFileName,"outputs/EleStudies_SFsysUp_%d_%s.root", mode, name);
      else if (!isData && SFminus) sprintf(rootFileName,"outputs/EleStudies_SFsysDown_%d_%s.root", mode, name);
      else if (!isData && unclusteredUp) sprintf(rootFileName,"outputs/EleStudies_METsysUp_%d_%s.root", mode, name);
      else if (!isData && unclusteredDown) sprintf(rootFileName,"outputs/EleStudies_METsysDown_%d_%s.root", mode, name);
      else if (!isData && PUsysUp) sprintf(rootFileName,"outputs/EleStudies_PUsysUp_%d_%s.root", mode, name);
      else if (!isData && PUsysDown) sprintf(rootFileName,"outputs/EleStudies_PUsysDown_%d_%s.root", mode, name);
      else if (!isData && !reweightPU) sprintf(rootFileName,"outputs/EleStudies_noPU_%d_%s.root", mode, name);
      else sprintf(rootFileName,"outputs/EleStudies_%d_%s.root", mode, name);
      ...
      myTree->Branch("flavLepton","std::vector<int>",&flavLepton);
      myTree->Branch("ecalRelIsoLepton","std::vector<double>",&ecalRelIsoLepton);
      myTree->Branch("trkRelIsoLepton","std::vector<double>",&trkRelIsoLepton);
      myTree->Branch("hcalRelIsoLepton","std::vector<double>",&hcalRelIsoLepton);
      myTree->Branch("totalRelIsoLepton","std::vector<double>",&totalRelIsoLepton);
      myTree->Branch("d0Lepton","std::vector<double>",&d0Lepton);
      myTree->Branch("etaLepton","std::vector<double>",&etaLepton);
      myTree->Branch("phiLepton","std::vector<double>",&phiLepton);


      myTree->Branch("eOverpLepton","std::vector<double>",&eOverpLepton);
      myTree->Branch("sigmaIetaIetaLepton","std::vector<double>",&sigmaIetaIetaLepton);
      myTree->Branch("deltaEtaSCTrkAtVtxLepton","std::vector<double>",&deltaEtaSCTrkAtVtxLepton);
      myTree->Branch("deltaPhiSCTrkAtVtxLepton","std::vector<double>",&deltaPhiSCTrkAtVtxLepton);
      myTree->Branch("convDistLepton","std::vector<double>",&convDistLepton);
      myTree->Branch("convDcotLepton","std::vector<double>",&convDcotLepton);
      myTree->Branch("numPixHitsLepton","std::vector<int>",&numPixHitsLepton);
      myTree->Branch("fbremLepton","std::vector<double>",&fbremLepton);
	 ...
	 */
	  ...
	  if(trigged){
		...
		// create some of the root tree objects here already as they need to be filled earlier.
		
		
		fbremLepton = new std::vector<double>(2,0);
		deltaEtaSCTrkAtVtxLepton = new std::vector<double>(2,0);
		deltaPhiSCTrkAtVtxLepton = new std::vector<double>(2,0);
		eOverpLepton = new std::vector<double>(2,0);
		convDistLepton = new std::vector<double>(2,0);
		convDcotLepton = new std::vector<double>(2,0);
		sigmaIetaIetaLepton = new std::vector<double>(2,0);
		numPixHitsLepton = new std::vector<int>(2,0);
                

		flavLepton = new std::vector<int>(2,0);
		ecalRelIsoLepton = new std::vector<double>(2,0.); 
		hcalRelIsoLepton = new std::vector<double>(2,0.); 
		trkRelIsoLepton = new std::vector<double>(2,0.); 
		totalRelIsoLepton = new std::vector<double>(2,0.); 
		numPixHitsLepton = new std::vector<int>(2,0);
		...
		d0Lepton = new std::vector<double>(2,0.); 
		etaLepton = new std::vector<double>(2,0.); 
		phiLepton = new std::vector<double>(2,0.); 
		...
		if (mode == 0){
		  ...
		  if (electron->Pt() > muon->Pt()){
		    ...
		    // add additional lepton info:

		    (*flavLepton)[0]=(11*(int)q0);
		    (*flavLepton)[1]=(13*(int)q1);
		    
		    (*eOverpLepton)[0]=electron->eScOverPin();
		    (*sigmaIetaIetaLepton)[0]=electron->sigmaIEtaIEta();
		    (*deltaEtaSCTrkAtVtxLepton)[0]=electron->deltaEtaScTrkOut();
		    (*deltaPhiSCTrkAtVtxLepton)[0]=electron->deltaPhiScTrkOut();
		    (*convDistLepton)[0]=electron->Dist();
		    (*convDcotLepton)[0]=electron->DCot();
		    (*fbremLepton)[0]=electron->fbrem();
		    (*numPixHitsLepton)[0]=electron->missingHits();
		    
		    
		    (*trkRelIsoLepton)[0]=(electron->chargedHadronIso()/electron->Pt());
		    (*trkRelIsoLepton)[1]=(muon->chargedHadronIso()/muon->Pt());
		    (*hcalRelIsoLepton)[0]=(electron->neutralHadronIso()/electron->Pt());
		    (*hcalRelIsoLepton)[1]=(muon->neutralHadronIso()/muon->Pt());
		    (*ecalRelIsoLepton)[0]=(electron->photonIso()/electron->Pt());
		    (*ecalRelIsoLepton)[1]=(muon->photonIso()/muon->Pt());
		    
		    (*totalRelIsoLepton)[0]=((electron->chargedHadronIso()+electron->neutralHadronIso()+electron->photonIso())/electron->Pt());
		    (*totalRelIsoLepton)[1]=((muon->chargedHadronIso()+muon->neutralHadronIso()+muon->photonIso())/muon->Pt());
		      
		    (*d0Lepton)[0]=(electron->d0());
		    (*d0Lepton)[1]=(muon->d0());
		    ...
		    (*flavLepton)[0]=(13*(int)q0);
		    (*flavLepton)[1]=(11*(int)q1);

		    (*eOverpLepton)[1]=electron->eScOverPin();
		    (*sigmaIetaIetaLepton)[1]=electron->sigmaIEtaIEta();
		    (*deltaEtaSCTrkAtVtxLepton)[1]=electron->deltaEtaScTrkOut();
		    (*deltaPhiSCTrkAtVtxLepton)[1]=electron->deltaPhiScTrkOut();
		    (*convDistLepton)[1]=electron->Dist();
		    (*convDcotLepton)[1]=electron->DCot();
		    (*fbremLepton)[1]=electron->fbrem();
		    (*numPixHitsLepton)[1]=electron->missingHits();

		    
		    (*trkRelIsoLepton)[0]=(muon->chargedHadronIso()/muon->Pt());
		    (*trkRelIsoLepton)[1]=(electron->chargedHadronIso()/electron->Pt());
		    (*hcalRelIsoLepton)[0]=(muon->neutralHadronIso()/muon->Pt());
		    (*hcalRelIsoLepton)[1]=(electron->neutralHadronIso()/electron->Pt());
		    (*ecalRelIsoLepton)[0]=(muon->photonIso()/muon->Pt());
		    (*ecalRelIsoLepton)[1]=(electron->photonIso()/electron->Pt());
		    
		    (*totalRelIsoLepton)[0]=((muon->chargedHadronIso()+muon->neutralHadronIso()+muon->photonIso())/muon->Pt());
		    (*totalRelIsoLepton)[1]=((electron->chargedHadronIso()+electron->neutralHadronIso()+electron->photonIso())/electron->Pt());
		      
		    (*d0Lepton)[0]=(muon->d0());
		    (*d0Lepton)[1]=(electron->d0());
		  ...
		  (*trkRelIsoLepton)[0]=(muon0->chargedHadronIso()/muon0->Pt());
		  (*hcalRelIsoLepton)[0]=(muon0->neutralHadronIso()/muon0->Pt());
		  (*ecalRelIsoLepton)[0]=(muon0->photonIso()/muon0->Pt());
		  (*totalRelIsoLepton)[0]=((muon0->chargedHadronIso()+muon0->neutralHadronIso()+muon0->photonIso())/muon0->Pt());
		  (*d0Lepton)[0]=(muon0->d0());
		  
		  (*trkRelIsoLepton)[1]=(muon1->chargedHadronIso()/muon1->Pt());
		  (*hcalRelIsoLepton)[1]=(muon1->neutralHadronIso()/muon1->Pt());
		  (*ecalRelIsoLepton)[1]=(muon1->photonIso()/muon1->Pt());
		  (*totalRelIsoLepton)[1]=((muon1->chargedHadronIso()+muon1->neutralHadronIso()+muon1->photonIso())/muon1->Pt());
		  (*d0Lepton)[1]=(muon1->d0());
		  ...
		  (*eOverpLepton)[0]=electron0->eScOverPin();
		  (*sigmaIetaIetaLepton)[0]=electron0->sigmaIEtaIEta();
		  (*deltaEtaSCTrkAtVtxLepton)[0]=electron0->deltaEtaScTrkOut();
		  (*deltaPhiSCTrkAtVtxLepton)[0]=electron0->deltaPhiScTrkOut();
		  (*convDistLepton)[0]=electron0->Dist();
		  (*convDcotLepton)[0]=electron0->DCot();
		  (*fbremLepton)[0]=electron0->fbrem();
		  (*numPixHitsLepton)[0]=electron0->missingHits();
		  

		  (*eOverpLepton)[1]=electron1->eScOverPin();
		  (*sigmaIetaIetaLepton)[1]=electron1->sigmaIEtaIEta();
		  (*deltaEtaSCTrkAtVtxLepton)[1]=electron1->deltaEtaScTrkOut();
		  (*deltaPhiSCTrkAtVtxLepton)[1]=electron1->deltaPhiScTrkOut();
		  (*convDistLepton)[1]=electron1->Dist();
		  (*convDcotLepton)[1]=electron1->DCot();
		  (*fbremLepton)[1]=electron1->fbrem();
		  (*numPixHitsLepton)[1]=electron1->missingHits();
		  
		  (*trkRelIsoLepton)[0]=(electron0->chargedHadronIso()/electron0->Pt());
		  (*hcalRelIsoLepton)[0]=(electron0->neutralHadronIso()/electron0->Pt());
		  (*ecalRelIsoLepton)[0]=(electron0->photonIso()/electron0->Pt());
		  (*totalRelIsoLepton)[0]=((electron0->chargedHadronIso()+electron0->neutralHadronIso()+electron0->photonIso())/electron0->Pt());
		  (*d0Lepton)[0]=(electron0->d0());
		  
		  (*trkRelIsoLepton)[1]=(electron1->chargedHadronIso()/electron1->Pt());
		  (*hcalRelIsoLepton)[1]=(electron1->neutralHadronIso()/electron1->Pt());
		  (*ecalRelIsoLepton)[1]=(electron1->photonIso()/electron1->Pt());
		  (*totalRelIsoLepton)[1]=((electron1->chargedHadronIso()+electron1->neutralHadronIso()+electron1->photonIso())/electron1->Pt());
		  (*d0Lepton)[1]=(electron1->d0());
		}
		...
		if (charge){
		  ...
		  if (leptonVeto) {
		    ...
		    if (pair.M() > 20){
		      ...
		      etaLepton = new std::vector<double>; 
		      phiLepton = new std::vector<double>; 
		      ...
		      etaLepton->push_back(lepton0.Eta());
		      etaLepton->push_back(lepton1.Eta());
		      
		      phiLepton->push_back(lepton0.Phi());
		      phiLepton->push_back(lepton1.Phi());
			...
			std::cout << "sqrts: " << topoWorkerNoBoost.get_sqrts() << std::endl; 
		      */
		      ...
		      delete etaLepton;
		      delete flavLepton;
		      delete ecalRelIsoLepton;
		      delete trkRelIsoLepton;
		      delete hcalRelIsoLepton;
		      delete totalRelIsoLepton;
		      delete d0Lepton;
		      delete fbremLepton;
		      

		      delete eOverpLepton;
		      delete sigmaIetaIetaLepton;
		      delete deltaEtaSCTrkAtVtxLepton;
		      delete deltaPhiSCTrkAtVtxLepton;
		      delete convDistLepton;
		      delete convDcotLepton;
		      delete numPixHitsLepton;
