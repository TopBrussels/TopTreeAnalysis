...
void plotmaker(int mode = 0){
  ...
  int rebinHisto[nPlots] =       { 1, 2, 2, 1, 1, 4, 12, 2, 1, 2, 2, 1, 1, 1};
  TString cutTitle[nPlots] =     { "Analysis Cut", "E_{T}^{miss}", "Inv. Mass", "# of jets", "# of jets(bt)" , "P_{T} system [GeV]", "H_{T} [GeV]","P_{T} of the leading jet", "# of vertex", "p_T of the first lepton [GeV]", "p_T  of the second lepton [GeV]", "# of vertex after cuts", "# of vertex after cuts PU reweighted", "# of vertex after cuts 3D PU reweighted"};
