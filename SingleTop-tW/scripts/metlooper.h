//////////////////////////////////////////////////////////
// This class has been cloned from freyametlooper.h
//////////////////////////////////////////////////////////
...
metlooper::metlooper(TTree *tree) : fChain(0) 
{
  Init(tree);
}
...
Int_t metlooper::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t metlooper::LoadTree(Long64_t entry)
{
...
void metlooper::Init(TTree *tree)
{
...
void metlooper::Show(Long64_t entry)
{
