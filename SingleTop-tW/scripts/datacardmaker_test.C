...
using namespace std;
void datacardmaker_test(){

  ofstream datacard("singletop_tW_5fb_jesjerpu.txt"); 
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(3) << 1 + fabs(((hup[0][j]->GetBinContent(2) + hup[1][j]->GetBinContent(2) + hup[2][j]->GetBinContent(2)) - average)/average) << "\t ";
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(3) << 1 + fabs(((hup[0][j]->GetBinContent(7) + hup[1][j]->GetBinContent(7) + hup[2][j]->GetBinContent(7)) - average)/average) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(3) << 1 + fabs(((hup[0][j]->GetBinContent(8) + hup[1][j]->GetBinContent(8) + hup[2][j]->GetBinContent(8)) - average)/average) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(4) << 1 + fabs(((h[0][j]->GetBinContent(2) + h[1][j]->GetBinContent(2) + h[2][j]->GetBinContent(2)) - average)/average) << "\t ";
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(4) << 1 + fabs(((h[0][j]->GetBinContent(7) + h[1][j]->GetBinContent(7) + h[2][j]->GetBinContent(7)) - average)/average) << "\t ";
	else datacard << setprecision(4) << "-\t ";
      }
      else datacard << setprecision(4) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
	...
	if (average !=0) datacard << setprecision(4) << 1 + fabs(((h[0][j]->GetBinContent(8) + h[1][j]->GetBinContent(8) + h[2][j]->GetBinContent(8)) - average)/average) << "\t ";
	else datacard << setprecision(4) << "-\t ";
      }
      else datacard << setprecision(4) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
   if ((hnominal[0][j]->GetBinContent(2)+ hnominal[1][j]->GetBinContent(2) + hnominal[2][j]->GetBinContent(2)) !=0){
	  double upv = (hup[0][j]->GetBinContent(2) + hup[1][j]->GetBinContent(2) + hup[2][j]->GetBinContent(2) - (hnominal[0][j]->GetBinContent(2)+ hnominal[1][j]->GetBinContent(2) + hnominal[2][j]->GetBinContent(2)))/(hnominal[0][j]->GetBinContent(2)+ hnominal[1][j]->GetBinContent(2) + hnominal[2][j]->GetBinContent(2));
         double downv = (hdown[0][j]->GetBinContent(2) + hdown[1][j]->GetBinContent(2) + hdown[2][j]->GetBinContent(2) - (hnominal[0][j]->GetBinContent(2)+ hnominal[1][j]->GetBinContent(2) + hnominal[2][j]->GetBinContent(2)))/(hnominal[0][j]->GetBinContent(2)+ hnominal[1][j]->GetBinContent(2) + hnominal[2][j]->GetBinContent(2));
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(j < 3){
      	if ((hnominal[0][j]->GetBinContent(7)+ hnominal[1][j]->GetBinContent(7) + hnominal[2][j]->GetBinContent(7)) !=0){
	  double upv = (hup[0][j]->GetBinContent(7) + hup[1][j]->GetBinContent(7) + hup[2][j]->GetBinContent(7) - (hnominal[0][j]->GetBinContent(7)+ hnominal[1][j]->GetBinContent(7) + hnominal[2][j]->GetBinContent(7)))/(hnominal[0][j]->GetBinContent(7)+ hnominal[1][j]->GetBinContent(7) + hnominal[2][j]->GetBinContent(7));
         double downv = (hdown[0][j]->GetBinContent(7) + hdown[1][j]->GetBinContent(7) + hdown[2][j]->GetBinContent(7) - (hnominal[0][j]->GetBinContent(7)+ hnominal[1][j]->GetBinContent(7) + hnominal[2][j]->GetBinContent(7)))/(hnominal[0][j]->GetBinContent(7)+ hnominal[1][j]->GetBinContent(7) + hnominal[2][j]->GetBinContent(7));
           double maxv = TMath::Max(fabs(upv), fabs(downv));
          if (upv*downv >= 0)  datacard << setprecision(4) << 1 + maxv << "\t ";
	  else if (upv < downv)  datacard << setprecision(4) << 1 + downv << "/" << 1+ upv<< "\t ";
	  else  datacard << setprecision(4) << 1 + upv << "/" << 1+ downv<< "\t ";
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(j < 3){
      	if ((hnominal[0][j]->GetBinContent(8)+ hnominal[1][j]->GetBinContent(8) + hnominal[2][j]->GetBinContent(8)) !=0){
	  double upv = (hup[0][j]->GetBinContent(8) + hup[1][j]->GetBinContent(8) + hup[2][j]->GetBinContent(8) - (hnominal[0][j]->GetBinContent(8)+ hnominal[1][j]->GetBinContent(8) + hnominal[2][j]->GetBinContent(8)))/(hnominal[0][j]->GetBinContent(8)+ hnominal[1][j]->GetBinContent(8) + hnominal[2][j]->GetBinContent(8));
         double downv = (hdown[0][j]->GetBinContent(8) + hdown[1][j]->GetBinContent(8) + hdown[2][j]->GetBinContent(8) - (hnominal[0][j]->GetBinContent(8)+ hnominal[1][j]->GetBinContent(8) + hnominal[2][j]->GetBinContent(8)))/(hnominal[0][j]->GetBinContent(8)+ hnominal[1][j]->GetBinContent(8) + hnominal[2][j]->GetBinContent(8));
           double maxv = TMath::Max(fabs(upv), fabs(downv));
          if (upv*downv >= 0)  datacard << setprecision(4) << 1 + maxv << "\t ";
	  else if (upv < downv)  datacard << setprecision(4) << 1 + downv << "/" << 1+ upv<< "\t ";
	  else  datacard << setprecision(4) << 1 + upv << "/" << 1+ downv<< "\t ";
