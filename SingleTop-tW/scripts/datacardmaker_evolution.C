...
void datacardmaker_evolution(){
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==0 && j == 0){
	if (hnominal[i][j]->GetBinContent(18) !=0) datacard << setprecision(3) << 1 + (hnominal[i][j]->GetBinError(19)/hnominal[i][j]->GetBinContent(19)) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==1 && j == 0){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(3) << 1 + (hnominal[i][j]->GetBinError(18)/hnominal[i][j]->GetBinContent(18)) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==1 && j == 0){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(3) << 1 + (hnominal[i][j]->GetBinError(19)/hnominal[i][j]->GetBinContent(19)) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 2 && j == 1){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(3) << 1 + (hnominal[i][j]->GetBinError(19)/hnominal[i][j]->GetBinContent(9)) << "\t ";
	else datacard << setprecision(3) << "-\t ";
      }
      else datacard << setprecision(3) << "-\t ";
    }
