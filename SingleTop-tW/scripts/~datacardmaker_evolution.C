...
void datacardmaker_evolution(){
  ...
  for (int process = 0; process < nProcess; process++){
    for (int i = 0; i < 3; i++){
      ...
      cout << "Reading " << title + processName[process] << ", ordered at " << mode << endl;
	...
	if (process == 3){
	  ...
	  cout << "Adding " << title + processName[process+1] << ", ordered at " << mode << endl;
  ...
  datacard << setprecision(4) << "imax 9 # number of bins " << endl;
  ...
  datacard << setprecision(4) << "bin \t\tee1j1t\t emu1j1t\t mumu1j1t\t ee2j1t\t emu2j1t\t mumu2j1t\t ee2j2t\t emu2j2t\t mumu2j2t " << endl;
  ...
  for (int i = 0; i < 3; i++){
    datacard << setprecision(4) << "\t " << hdata[i]->GetBinContent(18) ;
  }
  for (int i = 0; i < 3; i++){
    datacard << setprecision(4) << "\t " << hdata[i]->GetBinContent(19) ;
  }
  
  datacard << setprecision(4) << endl;
  datacard << setprecision(4) << "------------ " << endl;
  datacard << setprecision(4) << "bin        \tee1j1t\t ee1j1t\t ee1j1t\t emu1j1t\t emu1j1t\t emu1j1t\t mumu1j1t\t mumu1j1t\t mumu1j1t\t ee2j1t\t ee2j1t \t ee2j1t\t emu2j1t\t emu2j1t\t emu2j1t\t mumu2j1t\t mumu2j1t\t mumu2j1t\t ee2j2t\t ee2j2t\t ee2j2t\t emu2j2t\t emu2j2t\t emu2j2t\t mumu2j2t\t mumu2j2t\t mumu2j2t" << endl;
  datacard << setprecision(4) << "process    \tst\t tt\t other\t st\t tt\t other\t st\t tt\t other\t st\t tt\t other\t st\t tt\t other\t st\t tt\t other\t st\t tt\t other\t st\t tt    \t other\t st\t tt\t other" << endl;
  datacard << setprecision(4) << "process    \t0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2\t 0\t 1\t 2" << endl;
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << hnominal[i][j]->GetBinContent(18) << "\t ";
    }
  }
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << hnominal[i][j]->GetBinContent(19) << "\t ";
    }
  }
  datacard << setprecision(4) << endl;
  
  datacard << setprecision(4) << "---------------------- " << endl;
  datacard << setprecision(4) <<  "lumi      lnN\t1.022\t 1.022\t -\t1.022\t 1.022\t 1.022\t 1.022\t 1.022\t -\t 1.022\t 1.022\t 1.022\t 1.022\t 1.022\t 1.022\t1.022\t 1.022\t 1.022	1.022\t1.022\t 1.022    1.022\t 1.022\t 1.022    1.022\t 1.022\t 1.022 " << endl;
  datacard << setprecision(4) <<  "hlte      lnN\t1.015\t 1.015\t -\t1.011\t 1.011\t 1.011\t -\t  -\t  -\t 1.015\t 1.015\t 1.015\t 1.011\t 1.011\t 1.011\t-\t -\t -\t1.015\t1.015\t 1.015    1.011\t 1.011\t 1.011	-\t	-\t	- " << endl;
  datacard << setprecision(4) <<  "hltmu     lnN\t-\t  -\t  -\t1.011\t 1.011\t 1.011\t 1.015\t 1.015\t -\t -\t	-\t	-\t1.011\t 1.011\t 1.011	1.015\t 1.015\t 1.015\t -\t	-\t  -\t 1.011\t 1.011\t 1.011    1.015\t 1.015\t 1.015 " << endl;
  datacard << setprecision(4) <<  "ele       lnN\t1.02\t1.02\t-\t1.02\t1.02\t 1.02\t -\t  -\t -\t1.02\t 1.02\t1.02\t1.02\t1.02\t 1.02\t -\t -\t -\t1.02\t 1.02\t 1.02\t 1.02\t 1.02\t1.02\t -\t -\t - " << endl;
  datacard << setprecision(4) <<  "mu        lnN\t-\t  -\t  -\t1.01\t1.01\t 1.01\t 1.01\t1.01\t-\t  -\t  -\t -\t1.01\t1.01\t 1.01\t 1.01\t1.01\t1.01	-\t -\t  -\t 1.01\t 1.01\t1.01	 1.01\t1.01\t1.01 " << endl;
  ...
  for (int i = 0; i < 3; i++){
	...
	cout << "Reading " << modeName << ", " << title << ", ordered at " << mode << endl;
  ...
  for (int i = 0; i < 3; i++){
    ...
    for (int j = 0; j < 3; j++){
      char title[300];
      sprintf(title,"R_%s_",modeName);
      cout << "Reading " << modeName << ", " << title + processName[j+1]+ "__" + SystName + "__plus"  << ", ordered at " << mode << endl;
      hup[mode][j] = (TH1F*) (_file0->Get(title + processName[j+1]+ "__" + SystName + "__plus" ))->Clone();
      if (j == 2){
        cout << "Addding " << modeName << ", " << title + processName[j+2]+ "__" + SystName + "__plus"  << ", ordered at " << mode << endl;
	TH1F* h1 = (TH1F*) (_file0->Get(title + processName[j+2]+ "__" + SystName + "__plus"))->Clone();
	hup[mode][j]->Add(h1);
      }
      cout << "Reading " << modeName << ", " << title + processName[j+1]+ "__" + SystName + "__minus"  << ", ordered at " << mode << endl;
      hdown[mode][j] = (TH1F*) (_file0->Get(title + processName[j+1]+ "__" + SystName + "__minus"))->Clone();
      if (j == 2){
        cout << "Addding " << modeName << ", " << title + processName[j+2]+ "__" + SystName + "__minus" << ", ordered at " << mode << endl;
  ...
  for (int i = 0; i < 3; i++){
    ...
    for (int j = 0; j < 3; j++){
      ...
      hup[mode][j] = (TH1F*) (_file0->Get(title + processName[j+1]+ "__" + SystName + "__plus" ))->Clone();
      if (j == 2){
        cout << "Adding " << modeName << ", " << title + processName[j+2]+ "__" + SystName + "__plus"  << ", ordered at " << mode << endl;
	TH1F* h1 = (TH1F*) (_file0->Get(title + processName[j+2]+ "__" + SystName + "__plus"))->Clone();
	hup[mode][j]->Add(h1);
      }
      cout << "Reading " << modeName << ", " << title + processName[j+1]+ "__" + SystName + "__minus"  << ", ordered at " << mode << endl;
      hdown[mode][j] = (TH1F*) (_file0->Get(title + processName[j+1]+ "__" + SystName + "__minus"))->Clone();
      if (j == 2){
        cout << "Adding " << modeName << ", " << title + processName[j+2]+ "__" + SystName + "__minus"  << ", ordered at " << mode << endl;
	TH1F* h1 = (TH1F*) (_file0->Get(title + processName[j+2]+ "__" + SystName + "__minus"))->Clone();
	hdown[mode][j]->Add(h1);
      }  
    }
  ...
  datacard << setprecision(4) << "pdf       lnN\t1.020/0.978     1.024/0.975     -     1.018/0.980      1.024/0.975     -     1.018/0.98     1.024/0.975     -    1.025/0.974    1.024/0.975    -     1.021/0.977     1.023/0.976    -     1.019/0.978     1.023/0.976    -    1.019/0.979     1.022/0.976     -     1.021/0.978     1.024/0.975    -     1.02/0.978      1.023/0.976     -" << endl;

   
  datacard << setprecision(4) << "dynorm    lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==0 && j == 2)datacard << setprecision(4) << "1.33\t ";
      if(i ==1 && j == 2)datacard << setprecision(4) << "1.30\t ";
      if(i ==2 && j == 2)datacard << setprecision(4) << "1.27\t ";
      else datacard << setprecision(4) << "-\t ";
    }
  }
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(j == 2)datacard << setprecision(4) << "1.3\t ";
      else datacard << setprecision(4) << "-\t ";
    }
  }
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(j == 2)datacard << setprecision(4) << "-\t ";
      else datacard << setprecision(4) << "-\t ";
    }
  }
  datacard << setprecision(4) << endl;
  ...
  datacard << setprecision(4) << "mcstatst2 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==0 && j == 0){
	if (hnominal[i][j]->GetBinContent(18) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(18)/hnominal[i][j]->GetBinContent(18)) << "\t ";
	else datacard << setprecision(4) << "-\t ";
      }
      else datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatst3 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==0 && j == 0){
	if (hnominal[i][j]->GetBinContent(19) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(19)/hnominal[i][j]->GetBinContent(19)) << "\t ";
	else datacard << setprecision(4) << "-\t ";
      }
      else datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatst4 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==1 && j == 0){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatst5 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatst6 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatst7 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i ==2 && j == 0){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatst8 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatst9 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot1 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 0 && j == 1){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot4 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 1 && j == 1){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot5 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot6 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot7 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 2 && j == 1){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot8 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot9 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot10 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 0 && j == 2){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot11 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot12 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot13 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 1 && j == 2){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot14 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot15 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot16 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      if(i == 2 && j == 2){
	if (hnominal[i][j]->GetBinContent(2) !=0) datacard << setprecision(4) << 1 + (hnominal[i][j]->GetBinError(2)/hnominal[i][j]->GetBinContent(2)) << "\t ";
  ...
  datacard << setprecision(4) << "mcstatot17 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
  ...
  datacard << setprecision(4) << "mcstatot18 lnN\t";
  for (int i = 0; i < 3; i++){
    for (int j = 0; j <3; j++){ 
      datacard << setprecision(4) << "-\t ";
    }
