...
void tables(int mode = 0){
  ...
  TString processName[10] = { "twdr", "tt", "di", "wjets", "zjets", "st", "qcd_mu", "others", "data", "mc"};
  TString processLabel[10] = { "\\textbf{$tW$}", "\\textbf{$t \\bar{t}$}", "\\textbf{$WW$, $WZ$, $ZZ$}", "\\textbf{$W+jets$}", "\\textbf{$Z+jets$}",
