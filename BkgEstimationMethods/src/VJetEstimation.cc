...
VJetEstimation::VJetEstimation(UInt_t NofBtagWorkingPoint, Float_t* BtagWorkingPoint, UInt_t NofJets, UInt_t NofJetBins, UInt_t NofDatasets, vector<Int_t> iDTTLike, vector<Int_t> iDVLike, vector<Int_t> iDVbLike):TObject(){
	...
	Njets_ = new UInt_t[NbOfJetsBins_+1];
	for(UInt_t i=0;i<NbOfJetsBins_+1;i++) Njets_[i] = NofJets+i;
	NbOfBJetsBins_ = 4;
...
//	hNbOfBGenJets_                                 = new TH1F**[NbOfDatasets_];
	hNbOfBGenJets_                                 = vector< vector < TH1F* > >(NbOfDatasets_,vector < TH1F* >(NbOfJetsBins_,0) );
	hNbOfBGenJets_vs_JetPt_vs_JetEta_vs_Njets_     = vector< TH3F* >(NbOfDatasets_,0);
	hNbOfCGenJets_vs_JetPt_vs_JetEta_vs_Njets_     = vector< TH3F* >(NbOfDatasets_,0);
	hNbOfUDSGenJets_vs_JetPt_vs_JetEta_vs_Njets_   = vector< TH3F* >(NbOfDatasets_,0);
	hNbOfNonBGenJets_vs_JetPt_vs_JetEta_vs_Njets_  = vector< TH3F* >(NbOfDatasets_,0);

	hNbOfBGenBJets_vs_JetPt_vs_JetEta_vs_Njets_    = vector< vector < TH3F* > >(NbOfDatasets_,vector < TH3F* >(NbOfBtagWorkingPoint_,0) );
	hNbOfCGenBJets_vs_JetPt_vs_JetEta_vs_Njets_    = vector< vector < TH3F* > >(NbOfDatasets_,vector < TH3F* >(NbOfBtagWorkingPoint_,0) );
	hNbOfUDSGenBJets_vs_JetPt_vs_JetEta_vs_Njets_  = vector< vector < TH3F* > >(NbOfDatasets_,vector < TH3F* >(NbOfBtagWorkingPoint_,0) );
	hNbOfNonBGenBJets_vs_JetPt_vs_JetEta_vs_Njets_ = vector< vector < TH3F* > >(NbOfDatasets_,vector < TH3F* >(NbOfBtagWorkingPoint_,0) );
